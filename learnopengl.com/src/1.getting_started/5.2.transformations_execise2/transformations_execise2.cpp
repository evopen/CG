...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 rotation = glm::rotate(glm::mat4(1.f), (float)glfwGetTime(), glm::vec3(0, 0, 1));
		glm::mat4 translation = glm::translate(glm::mat4(1.f), glm::vec3(0.5, 0.5, 0.5));
		glm::mat4 trans = translation * rotation;
		// trans = glm::scale(trans, glm::vec3(0.5, 0.5, 0.5));

		GLuint transform = glGetUniformLocation(shader.programID, "transform");
		...
		// second container with different transform
		glm::mat4 scale = glm::scale(glm::mat4(1.f), glm::vec3(color));
		translation = glm::translate(glm::mat4(1.f), glm::vec3(-0.6, 0.6, 0));
		trans = translation * scale;
		glUniformMatrix4fv(transform, 1, GL_FALSE, glm::value_ptr(trans));
		glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
