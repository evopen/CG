...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		cubeShader.setFloat("material.shininess", 256);
		...
		cubeShader.setVec3("dirLight.direction", 0, -1, 0);
		cubeShader.setVec3("dirLight.ambient", 0.1f, 0.1f, 0.1f);
		cubeShader.setVec3("dirLight.diffuse", 0.6f, 0.6f, 0.6f); // darken the light a bit to fit the scene
		...
		cubeShader.setFloat("spotLight.innerCutoff", glm::cos(glm::radians(8.f)));
		cubeShader.setFloat("spotLight.outerCutoff", glm::cos(glm::radians(15.f)));
		cubeShader.setFloat("spotLight.constant", 1.0f);
		cubeShader.setFloat("spotLight.linear", 0.09f);
		cubeShader.setFloat("spotLight.quadratic", 0.032f);
		cubeShader.setVec3("spotLight.ambient", 0.1f, 0.1f, 0.1f);
		cubeShader.setVec3("spotLight.diffuse", 0.8f, 0.8f, 0.8f); // darken the light a bit to fit the scene
		cubeShader.setVec3("spotLight.specular", 1.0f, 1.0f, 1.0f);
		/// 

		/// setup point light config
		...
		cubeShader.setVec3("pointLights[0].diffuse", 0.6f, 0.6f, 0.6f); // darken the light a bit to fit the scene
		cubeShader.setVec3("pointLights[1].diffuse", 0.6f, 0.6f, 0.6f); // darken the light a bit to fit the scene
		cubeShader.setVec3("pointLights[2].diffuse", 0.6f, 0.6f, 0.6f); // darken the light a bit to fit the scene
		cubeShader.setVec3("pointLights[3].diffuse", 0.6f, 0.6f, 0.6f); // darken the light a bit to fit the scene
