...
namespace dhh::shader
{
	...
	public:
		...
		void createPipeline()
		{
			...
			VkPipelineColorBlendStateCreateInfo colorBlendInfo = dhh::vk::initializer::
				pipelineColorBlendStateCreateInfo(
					colorBlendAttachmentState);

			VkPipelineVertexInputStateCreateInfo vertexInputInfo = dhh::vk::initializer::
				pipelineVertexInputStateCreateInfo(
					vertexInputBindingDescriptions, vertexInputAttributeDescriptions);

			VkGraphicsPipelineCreateInfo pipelineInfo = dhh::vk::initializer::graphicsPipelineCreateInfo(
				shaderStageCreateInfos, renderPass, pipelineLayout);
